...
class LSHADE(JADE):
    ...
    def __init__(self, problem, options, rand_seed, optimal_value):
        ...
        # restart
        self.rotation = problem.get('rotation', None)  # rotation matrix for the problem
        self.lambda_ = problem.get('lambda_', None)  # lambda for the problem
        self.omega_ = problem.get('omega_', None)  # Mu for the problem
        self.optimal_value = optimal_value
        self.restart_threshold = 5e4  # 1e6
